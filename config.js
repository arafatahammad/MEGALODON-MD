...
module.exports = {
    ...
    SESSION_ID: process.env.SESSION_ID || "MEGALODON~MD~DZdUSJiL#_GLKpIx-h8l5SrUhpnO9MSUtXioxl5Th549V0uycro0",  // Your bot's session ID (keep it secure)
    ...
    OWNER_NUMBER: process.env.OWNER_NUMBER || "01871974894",  // Owner's WhatsApp number
    
    OWNER_NAME: process.env.OWNER_NAME || getConfig("OWNER_NAME") || "01871974894",           // Owner's name
    
    DEV: process.env.DEV || "01871974894",                     // Developer's contact number
